...
SELECT MAIN.PATIENT_ID
	...
	,FTA.OP_visit
	,FTA.ED_visit
	,FTA.PLMG_visit AS CRSwNP_PLMG_visit
	,FTA.ALGY_visit AS CRSwNP_ALGY_visit
	,FTA.ORL_visit AS CRSwNP_ORL_visit
	,FTA.OP_visit AS CRSwNP_OP_visit
	,FTA.ED_visit AS CRSwNP_ED_visit
