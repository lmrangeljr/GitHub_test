...
SELECT MAIN.PATIENT_ID
	,MAIN.INDEX_DATE
	,MAIN.RUN_ID
	,CASE WHEN FTA.PLMG_visit IS NULL THEN 0 ELSE FTA.PLMG_visit END AS PLMG_visit
	,CASE WHEN FTA.ALGY_visit IS NULL THEN 0 ELSE FTA.ALGY_visit END AS ALGY_visit
	,CASE WHEN FTA.ORL_visit IS NULL THEN 0 ELSE FTA.ORL_visit END AS ORL_visit
	,CASE WHEN FTA.OP_visit IS NULL THEN 0 ELSE FTA.OP_visit END AS OP_visit
	,CASE WHEN FTA.ED_visit IS NULL THEN 0 ELSE FTA.ED_visit END AS ED_visit
	,CASE WHEN FTA.CRSwNP_PLMG_visit IS NULL THEN 0 ELSE FTA.CRSwNP_PLMG_visit END AS CRSwNP_PLMG_visit
	,CASE WHEN FTA.CRSwNP_ALGY_visit IS NULL THEN 0 ELSE FTA.CRSwNP_ALGY_visit END AS CRSwNP_ALGY_visit
	,CASE WHEN FTA.CRSwNP_ORL_visit IS NULL THEN 0 ELSE FTA.CRSwNP_ORL_visit END AS CRSwNP_ORL_visit
	,CASE WHEN FTA.CRSwNP_OP_visit IS NULL THEN 0 ELSE FTA.CRSwNP_OP_visit END AS CRSwNP_OP_visit
	,CASE WHEN FTA.CRSwNP_ED_visit IS NULL THEN 0 ELSE FTA.CRSwNP_ED_visit END AS CRSwNP_ED_visit
