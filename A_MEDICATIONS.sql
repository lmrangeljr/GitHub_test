...
SELECT DISTINCT MAIN.PATIENT_ID
	...
	,COUNT(DISTINCT CASE WHEN BASE.MED_CUIS IN('boc000600','boc003042','boc008640','boc004274','boc005247','boc005244','boc005246','boc011543') AND BASE.SPECIALTY_CUI = 'boc002359' THEN BASE.MEDICATION_START ELSE NULL END) AS SPEC_OTOLAR
...
SELECT MAIN.PATIENT_ID
				...
				,CASE WHEN FTA.SPEC_OTOLAR > 0 THEN 1 ELSE 0 END AS SPEC_OTOLAR
