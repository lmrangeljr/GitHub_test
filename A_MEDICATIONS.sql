...
SELECT DISTINCT MAIN.PATIENT_ID
	...
	,COUNT(DISTINCT CASE WHEN BASE.MED_CUIS IN('boc000600','boc003042','boc008640','boc004274','boc005247','boc005244','boc005246','boc011543') AND BASE.SPECIALTY_CUI != 'Include the CUI for ENT' THEN BASE.MEDICATION_START ELSE NULL END) AS SPEC_OTHER
...
SELECT MAIN.PATIENT_ID
				...
				,CASE WHEN FTA.SPEC_PULM = 1 AND FTA.SPEC_ALRG = 1 THEN 0 ELSE 1 END AS SPEC_OTHER
